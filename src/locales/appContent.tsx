  ...
  en: {
    ...
    commands: {
      ...
      experience: [
        ...
        "2026",
        "Internship",
        "   REFACTORMI SRL · Internship",
        "   ┌─ Experience within a digital development team, involving frontend and backend development, database management, and UI/UX design. Participation in the analysis, design, and development of features for a web application, including the creation of prototypes and technical solutions later shared with the team.",
        "   └─ Mar 2026 - May 2026 · 3 months | Hybrid",
        "",
        "2025",
        "Internship",
        "   Incoming Partners · Internship",
        "   ┌─ Developed a mini web app for managing company attendance via QR code, built with Google Apps Script, Google Sheets, and Google Forms. The system generates QR codes for each employee and, when scanned, automatically updates the online attendance register with daily data.",
        "   └─ Oct 2025 · 1 month",
        "",
        "2025",
        "Internship",
        "   Exlibris · Internship",
        "   ┌─ Built a stateless CMS with React (TSX) and Strapi to replace the previous PPTX-based system, enabling the creation and management of web-based digital presentations through custom dynamic blocks.",
        "   └─ Aug 2025 - Oct 2025 · 3 months | Milan, Lombardy, Italy · On-site",
        "",
        "2022 – 2023",
  ...
  it: {
    ...
    commands: {
      ...
      experience: [
        ...
        "2026",
        "Stage",
        "   REFACTORMI SRL · Stage",
        "   ┌─ Esperienza in un team di sviluppo digitale con coinvolgimento in attività di frontend, backend, gestione database e progettazione UI/UX. Partecipazione all’analisi, progettazione e sviluppo di funzionalità per un’applicazione web, con realizzazione di prototipi e soluzioni tecniche poi condivise con il team.",
        "   └─ mar 2026 - mag 2026 · 3 mesi | Ibrida",
        "",
        "2025",
        "Stage",
        "   Incoming Partners · Stage",
        "   ┌─ Sviluppo di un mini applicativo web per la gestione delle presenze aziendali tramite QR code, realizzato con Google Apps Script, Google Sheets e Google Forms. Il sistema genera i QR code per ciascun dipendente e, tramite scansione, aggiorna automaticamente il registro presenze online con i dati giornalieri corrispondenti.",
        "   └─ ott 2025 · 1 mese",
        "",
        "2025",
        "Stage",
        "   Exlibris · Stage",
        "   ┌─ Realizzazione di un CMS stateless con React (TSX) e Strapi per sostituire il precedente sistema basato su file PPTX, consentendo la creazione e la gestione di presentazioni digitali web-based tramite blocchi dinamici personalizzati.",
        "   └─ ago 2025 - ott 2025 · 3 mesi | Milano, Lombardia, Italia · In sede",
        "",
        "2022 – 2023",
